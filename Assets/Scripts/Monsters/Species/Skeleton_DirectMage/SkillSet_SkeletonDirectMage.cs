...
{
    public class SkillSet_SkeletonDirectMage : SkillSet
    {
        ...
        public void BaseAttack()
        {
            ...
            {
                HitBox bullet1 = Instantiate(baseAttackHitbox).GetComponent<HitBox>();
                bullet1.BulletParticle_Play(heart, bulletPos.position, transform.forward + transform.right * 0.75f);
                HitBox bullet2 = Instantiate(baseAttackHitbox).GetComponent<HitBox>();
                bullet2.BulletParticle_Play(heart, bulletPos.position, transform.forward - transform.right * 0.75f);
            }
        }
